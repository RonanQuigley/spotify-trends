...
Results.prototype.processSpotifyData = function(req, res, next) {
  ...
  res.locals.finalResults = {
    topArtistsFourWeeks: spotifyResults.getRelevantArtistsData(results.topArtists.fourWeeks),
    topArtistsSixMonths: spotifyResults.getRelevantArtistsData(results.topArtists.sixMonths),
    topArtistsAllTime: spotifyResults.getRelevantArtistsData(results.topArtists.allTime),
    topTracksFourWeeks: spotifyResults.getRelevantTracksData(results.topTracks.fourWeeks),
    topTracksSixMonths: spotifyResults.getRelevantTracksData(results.topTracks.sixMonths),
    topTracksAllTime: spotifyResults.getRelevantTracksData(results.topTracks.allTime)
  };
  next();
}
