export default {
    SHORT: [
        {
            ...
            analysis_url:
                'https://api.spotify.com/v1/audio-analysis/33MhyD4tOUTPDrJtUOmlzy',
            duration_ms: 231919,
            time_signature: 3
        },
        {
    ...
    MEDIUM: [
        ...
        },
        {
            ...
            track_href:
                'https://api.spotify.com/v1/tracks/4VqPOruhp5EdPBeR92t6lQ',
            analysis_url:
    ...
    LONG: [
        {
            ...
            analysis_url:
                'https://api.spotify.com/v1/audio-analysis/0sp00HSXkQyqTa6QqM0O8V',
            duration_ms: 209307,
            time_signature: 4
        },
        {
